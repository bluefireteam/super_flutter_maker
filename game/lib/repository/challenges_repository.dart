...
class ChallengeRepository {
  ...
  ChallengeRepository() {
    ...
    helloWorldChallenge.child = CenterWidget()..setPropertyValue(
      'child',
      TextWidget()..setPropertyValue('text', 'Hello World'),
    );
    ...
    helloWorldChallenge2.child = CenterWidget()..setPropertyValue(
      'child',
      ColumnWidget()..setPropertyValue(
        'children',
        [
  ...
  List<Challenge> allChallenges() => _challenges;
